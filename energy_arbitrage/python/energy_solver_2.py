"""Exploitative solver that uses future knowledge (matches Rust energy_solver_2.rs)."""
...
def policy(challenge: "PolicyView", state: "State") -> list[float]:
    """Exploitative policy that uses future DA prices and exogenous injections."""
    ...
    for i, _battery in enumerate(challenge.batteries):
        ...
        elif current_da > future_avg + 1.0 + threshold_adjust:
